...
image:https://travis-ci.org/riboseinc/rfc-asciirfc-minimal.svg?branch=master["Build Status", link="https://travis-ci.org/riboseinc/rfc-asciirfc-minimal"]
...
https://github.com/riboseinc/metanorma-ietf[`metanorma-ietf` gem].
